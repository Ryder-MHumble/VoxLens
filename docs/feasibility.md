...
- **产品内置采集运行时**：VoxLens crawler runtime 已覆盖小红书/RedNote、抖音、快手、B站、微博、知乎等当前 alpha 需要的平台，并支持 CDP 真实浏览器模式，是合适的工程基底。

## 2. 可行性判断

### 可以做的部分

- 跨平台关键词搜索：可行，B站/YouTube/小红书都已有可自动化入口；VoxLens crawler runtime 可补抖音、快手、微博、知乎等中文平台。
